...
int command_sha1(int argc, const char *argv[]) {
    return command_sha_general("SHA1", 160, sha1, argc, argv);
}

int command_sha224(int argc, const char *argv[]) {
    return command_sha_general("SHA224", 224, sha224, argc, argv);
}

int command_sha256(int argc, const char *argv[]) {
    return command_sha_general("SHA256", 256, sha256, argc, argv);
}

int command_sha512(int argc, const char *argv[]) {
    return command_sha_general("SHA512", 512, sha512, argc, argv);
}
