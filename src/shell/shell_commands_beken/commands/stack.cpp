...
static const struct {
    ...
    {"unused", 0xaaaaaaaa, &_stack_unused, &_stack_svc}, {"svc", 0xbbbbbbbb, &_stack_svc, &_stack_irq},
    {"irq", 0xcccccccc, &_stack_irq, &_stack_fiq},       {"fiq", 0xdddddddd, &_stack_fiq, &_stack_sys},
    {"sys", 0xeeeeeeee, &_stack_sys, ram_end},
};

static const Table::ColumnDef table_def[] = {
    {"name", 10, "%s", Table::Align::Left},       {"color", 10, "0x%08lx", Table::Align::Right},
    {"addr", 10, "0x%08lx", Table::Align::Right}, {"size (hex)", 10, "0x%lx", Table::Align::Right},
    {"used", 8, "0x%lx", Table::Align::Right},    {"p", 4, "%3d%%", Table::Align::Right},
};
