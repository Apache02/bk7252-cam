...
static int aes_oneshot(AES_MODE mode, bool encode, const uint8_t *key, const uint8_t *input, uint8_t *output,
                       size_t length) {
    if (length % AES_BLOCK_SIZE != 0) return -1;
